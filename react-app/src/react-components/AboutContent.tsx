export default function AboutContent() {
    ...
    return <div>
        ...
        <p>The publicly hosted version of this app uses the dataset from May 1, 2026. If you would like to run the app with a more up-to-date dataset, you will need the inventories.csv, sets.csv, and inventory_parts.csv files from <a href="https://rebrickable.com/downloads/" target="_blank" rel="noopener noreferrer">Rebrickable's download page</a>, along with the app itself, discussed below.</p>
        <h2>Code</h2>
        <p>You can find the code for this app <a href="https://github.com/cadenceblorbo/BrickStat" target="_blank" rel="noopener noreferrer">on GitHub</a>. If you would like to run the app on your own, check out the project's README.</p>
